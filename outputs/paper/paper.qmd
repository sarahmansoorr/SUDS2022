...
Figure 4 shows an decreasing pattern for the mean pollution from year 2002 to 2020 for NO by year. We can notice that O3 and SO2 levels remain mostly the same throughout the years.
...
Figure 5 shows a decreasing pattern for the mean pollution from year 2002 to 2020 for CO by year.
